...
output_path = './compaction/characterization_factors/aggregated/cf_ts_countries_yearly'
...
r_mx = raster(paste0('./compaction/characterization_factors/mx_ts_yearly.tif'))
# Raster with the multiplicative standard deviation (sd*)
r_sdx = raster(paste0('./compaction/characterization_factors/sdx_ts_yearly.tif'))
