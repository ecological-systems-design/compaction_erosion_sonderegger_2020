...
output_path = './compaction/characterization_factors/aggregated/cf_ms_countries_yearly'
...
r_mx = raster(paste0('./compaction/characterization_factors/mx_ms_yearly.tif'))
# Raster with the multiplicative standard deviation (sd*)
r_sdx = raster(paste0('./compaction/characterization_factors/sdx_ms_yearly.tif'))
