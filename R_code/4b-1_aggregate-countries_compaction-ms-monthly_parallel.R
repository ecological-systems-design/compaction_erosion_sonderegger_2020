...
output_path = './compaction/characterization_factors/aggregated/cf_ms_countries_'
...
for (month in 1:12) {
  ...
  r_mx = raster(paste0('./compaction/characterization_factors/mx_ms_', i, '.tif'))
  # Raster with the multiplicative standard deviation (sd*)
  r_sdx = raster(paste0('./compaction/characterization_factors/sdx_ms_', i, '.tif'))
